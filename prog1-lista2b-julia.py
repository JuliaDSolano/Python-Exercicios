...
def decompor_numero(numero):
    ...
    if numero < 1000:
        ...
        dezenas = math.floor(numero % 100)
        dezenas = math.floor(dezenas / 10)
...
def caixa_eletronico(valor):
    ...
    if valor <= 600:
        ...
        n50 = (valor % 100) // 50
        n25 = ((valor % 100) % 50) // 25
        n10 = (((valor % 100) % 50) % 25) // 10
        n5 = ((((valor % 100) % 50) % 25) % 10) // 5
        n1 = (((((valor % 100) % 50) % 25) % 10) % 5) // 1

        resposta = []

        if n100 > 0:
            resposta.append((100, n100))
        if n50 > 0:
            resposta.append((50, n50))
        if n25 > 0:
            resposta.append((25, n25))
        if n10 > 0:
            resposta.append((10, n10))
        if n5 > 0:
            resposta.append((5, n5))
        if n1 > 0:
            resposta.append((1, n1))
